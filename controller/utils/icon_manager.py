...
# Local imports
from controller.utils import qtawesome as qta


_resource = {
    'directory': osp.join(osp.dirname(osp.realpath(__file__)), '../ui/fonts'),
    'loaded': False,
}
...
def get_image_path(name, default="not_found.png"):
    ...
    if default is not None:
        img_path = osp.join(get_module_path('controller'), 'ui', 'images')
...
def icon(name, resample=False, icon_path=None):
    ...
    if not _resource['loaded']:
        qta.load_font('controller_ui', 'spyder.ttf', 'spyder-charmap.json',
