...
# It is created to introduce as many aspects of 'server.core' as possible.
...
from server.core.handlers import ResponseOnlyHandler
from server.core.orchestration import StegoOrchestrator
from server.core.datamanipulation import asciiToHexTemplate

from server.core.shells.impl import StandardShell, ExtendableShell
...
Cookie: SESSIOID=~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
eTag: ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
User-Agent: server.core HTTP-shell by John Torakis
...
#============================== Networking part =========================
# The networking is handled by Python API. No 'server.core' code here...
...
server_socket.listen(5)			# independently of server.core
...
# 'send' and 'recv' are wrappers for Handler object networking. server.core is network agnostic
