...
from server.core.datamanipulation import Compressor
...
class SimpleOrchestrator ( Orchestrator ) :
	"""
The `SimpleOrchestrator` class combines compression, chunking, encryption and stream tagging, by utilizing the below ``server.core`` classes:

 - :class:`server.core.datamanipulation.Chunker`
...
:param int out_length: The data length of the chunks that are returned by the :func:`server.core.orchestration.SimpleOrchestrator.readyMessage`.
:param int in_length: The data length of the chunks that will be passed to :func:`server.core.orchestration.SimpleOrchestrator.depositChunk`.
