...
from server.core.helpers import xor_str
...
**(stream, message)** tuples are recognised by the classes in :mod:`server.core.handlers` but data transmission is only possible with `raw data`.
