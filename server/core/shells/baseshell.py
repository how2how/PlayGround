...
class BaseShell( cmd.Cmd ) :
	"""
The base class of the package. It implements basics, like hooking the :class:`server.core.handlers.basehandler.BaseHandler` and giving a handle for further incoming message proccessing.
	"""
	...
	def updatePrompt( self ) :
		self.prompt = self.prompt_templ.format( package = server.core.__name__, version = server.core.__version__  )
