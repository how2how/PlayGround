...
from server.core.shells.subshells import SimpleSubShell		# fallback shell
from server.core.handlers import StageableHandler		# For the static method

from server.core.payloads import import_stage_from_module, import_stage_from_module_str
...
class StageSubShell ( SimpleSubShell ) :
	...
	def help_mload( self ) :
		...
		print( "\tmload <module>" )
		print( "mload example:" )
		print( "\tmload server.core.payloads.windows.shellcode" )
