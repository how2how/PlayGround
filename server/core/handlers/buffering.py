...
`BufferingHandler.__init__` has to run in the object in order to initiate the buffering process of `BufferingHandler`.
        ...
        BufferingHandler.__init__(handler_obj, handler_obj.receive_function, handler_obj.send_function,
                                  handler_obj.getOrchestrator())  # Runs the __init__ code only for BufferingHandler
