from server.core.datamanipulation import StegoInjector
...
It uses the :class:`server.core.datamanipulation.stegoinjector.StegoInjector` class to create alterations to existing data chunks.
...
"""
	def __init__( self, stego_configuration, transformation_list ) :
		"""
:param str stego_configuration: The Stego Configuration to initialize the internal :class:`server.core.datamanipulation.stegoinjector.StegoInjector` object.
...
:param str template: The template string that describes the given data packet. If `None` the :func:`server.core.datamanipulation.stegoinjector.StegoInjector.guessTemplate` function will try to guess the correct template.
:rtype: str
