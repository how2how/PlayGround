"""
This code isn't really useful and it is meant to be a guide for making custom `stages` using the ``server.core`` API
"""
def init(storage) :
	'''
...
from server.core.shells.subshells import ExampleSubShell as shell
