...
def generatePayloads( ) :
	...
	from server.core.payloads.linux import shellcode as lshellcode
	...
	from server.core.payloads.windows import shellcode as wshellcode
	...
	from server.core.payloads.generic import control, shell, shellprocess, pythonapi, echo, meterpreter, file as file_
