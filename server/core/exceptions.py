"""
All exception of ``server.core`` package are provided centrically in this module.

"""


class TemplateNotFoundException(Exception):
	''' This Exception is thrown when the template passed as argument is not available in the :class:`server.core.datamanipulation.stegoinjector.StegoInjector` configuration string '''
